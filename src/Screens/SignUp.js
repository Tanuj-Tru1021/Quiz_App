...
const SignUp = ({ navigation }) => {
    ...
    const disable = !reg.test(email) || firstName.length === 0 || lastName.length === 0 || (course1 === false && course2 === false && course3 === false) || programme.length === 0 || mobileNumber.length < 10
    ...
    const signUpUser = () => {
        makeRequest({
            ...
            body: {
                ...
                'roll_number': enrollNumber,
                'teachers': []
            },
            onSuccess: () => navigation.navigate('NewLogin'),
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#374259' }}>
            ...
            <View style={{ paddingHorizontal: 20 }}>
                ...
                {show &&
                    <>
                        <Text style={{ fontSize: 12, fontWeight: 400, color: 'white', marginTop: 30 }}>
            ...
            <TouchableOpacity
                style={{
                    ...
                    alignSelf: 'center', borderRadius: 10, marginTop: 40, marginBottom: 20
                }}
                onPress={() => {
                    signUpUser()
                }}
